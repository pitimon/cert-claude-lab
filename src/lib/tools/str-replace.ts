...
export const buildStrReplaceTool = (fileSystem: VirtualFileSystem) => {
  return tool({
    description:
      "A text editor tool for creating, viewing, and editing files. Supports creating new files, viewing file contents, replacing text, and inserting text at specific line numbers.",
